...
//    -	paintComponent																				//
	...
	/** Draw border for ColoredBorder feature.<br />
	*  Draw the BackgroundImage resized image.
	*/
	protected void paintComponent( Graphics g ){
		...
		if( resized_image != null ) {
			int x = (resized_image.getWidth() < getSize().width)?((getSize().width-resized_image.getWidth())/2):(0);
			int y = (resized_image.getHeight() < getSize().height)?((getSize().height-resized_image.getHeight())/2):(0);
			g.drawImage( resized_image, x, y, null );
		}
